...
public class LivrosEsportesController implements Route {
    ...
    public String handle(Request request, Response response) throws Exception {
        ...
        html.append("<html>");
        html.append("<head>");
        html.append("<title>Lista de Livros de Esporte - BibliotecaApp</title>");
        ...
        html.append("<nav class=\"navbar navbar-expand-lg navbar-dark bg-dark\">\n" +
                ...
                "            <a class=\"dropdown-item active\" href=\"/livrosEsportes/lista\">Livros de esportes</a>\n" +
        ...
        html.append("<h3>Lista de Livros de Esportes</h3><br>");
        html.append("<a href=\"/livrosEsportes/newLivroEsporte/incluir\" class=\"btn btn-success mr-2\">Adicionar Livro</a>");
