...
public class FuncionarioController implements Route{
	...
	public String handle(Request request, Response response) throws Exception {
		...
		Funcionario funcionario2 = new Funcionario("Lauro Victor", "Coordenador", 1997);
		...
		html.append("<h3>Lista de Funcionários</h3><br>");
		html.append("<a href=\"/funcionario/newFuncionario/incluir\" class=\"btn btn-success mr-2\">Criar Funcionário</a>");
		...
		html.append("<div class=\"container mt-5\">\n" +
				...
				"                </li>\n" +
				"                <li class=\"list-group-item\">\n" +
				"                    <strong>Nome:</strong> <span class=\"text-muted\">"+funcionario1.getNome()+"</span>\n" +
				"                </li>\n" +
				"                <li class=\"list-group-item\">\n" +
		...
		html.append("<div class=\"container mt-5\">\n" +
				...
				"                </li>\n" +
				"                <li class=\"list-group-item\">\n" +
				"                    <strong>Nome:</strong> <span class=\"text-muted\">"+funcionario2.getNome()+"</span>\n" +
				"                </li>\n" +
				"                <li class=\"list-group-item\">\n" +
